// components/MerchantCard.js

export function PaystackCard() {
  return (
    <div className="grid rounded-3xl bg-gray-50 p-5 text-gray-800 shadow-md w-1/4 place-content-center gap-y-36">
      <div className="text-3xl font-semibold text-center">Paystack</div>
      <div className="flex space-x-4 rounded-2xl w-52 bg-red-50 p-5">
        ...
        <div>
          <div className=" font-semibold">N100,000</div>
          <div className="text-gray-700 text-xs">Money In</div>
          <div className="text-blue-700 text-[10px]">+8% from yesterday</div>
        </div>
      </div>
    </div>
  );
...
export function PagaCard() {
  return (
    <div className="grid rounded-3xl bg-gray-50 p-5 text-gray-800 shadow-md w-1/4 place-content-center gap-y-36">
      <div className="text-3xl font-semibold text-center">Paga</div>
      <div className="flex space-x-4 rounded-2xl w-52 bg-red-50 p-5">
        <div className="h-10 w-10 rounded-full p-3 bg-[#FA5A7D]">
          <svg
            width="10"
        ...
        <div>
          <div className=" font-semibold">N200,000</div>
          <div className="text-gray-700 text-xs">Money In</div>
          <div className="text-blue-700 text-[10px]">+12% from yesterday</div>
        </div>
      </div>
    </div>
  );
